...
angular
    ...
    .config(function ($routeProvider, LoopBackResourceProvider, $compileProvider) {
        $routeProvider
            ...
            .when('/organisation/:organisationid/manager/:managerid/view', {
                templateUrl : 'views/view-organisation.html',
                controller : 'ViewOrganisationCtrl'
            })
            .when('/organisation/:organisationid/manager/:managerid/edit', {
